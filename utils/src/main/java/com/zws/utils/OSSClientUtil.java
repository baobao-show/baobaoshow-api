...
public class OSSClientUtil {
    ...
    protected static String endpoint = "oss-ap-south-1.aliyuncs.com";
    protected static String accessKeyId  = "LTAI4cDGJ67v2emW";
    protected static String accessKeySecret  = "x3wGQzMFCW6szmCuH6pxpdrHE2K133";
    protected static String bucketName  = "want-lady";
    //文件存储目录
